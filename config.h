...
static char normfgcolor[]           = "#e6e1cf";
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_w,		spawn,		{.v = (const char*[]){ "thorium-browser", NULL } } },
	...
	{ MODKEY|ShiftMask,	XK_s,		spawn,		{.v = (const char*[]){ BROWSER, NULL } } },
	...
	/* { MODKEY,			XK_F6,		spawn,		{.v = (const char*[]){ "xbacklight", "-inc", "15", NULL } } }, */
	/* { MODKEY|ShiftMask,	XK_F6,		spawn,		{.v = (const char*[]){ "xbacklight", "-dec", "15", NULL } } }, */
	{ MODKEY,			XK_F5,		xrdb,		{.v = NULL } },
	/* { MODKEY,			XK_F6,		spawn,		{.v = (const char*[]){ "qbittorrent", NULL } } }, */
	/* { MODKEY,			XK_F7,		spawn,		{.v = (const char*[]){ "td-toggle", NULL } } }, */
	/* { MODKEY,			XK_F8,		spawn,		{.v = (const char*[]){ "mailsync", NULL } } }, */
	{ MODKEY,			XK_F9,		spawn,		{.v = (const char*[]){ "mounter", NULL } } },
	{ MODKEY,			XK_F10,		spawn,		{.v = (const char*[]){ "unmounter", NULL } } },
	{ MODKEY,			XK_F11,		spawn,		SHCMD("mpv --untimed --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --title=webcam $(ls /dev/video0 | tail -n 1)") },
	{ MODKEY,			XK_F12,		spawn,		SHCMD("remaps") },
	{ MODKEY,			XK_space,	zoom,		{0} },
	{ MODKEY|ShiftMask,	XK_space,	togglefloating,	{0} },

	{ 0,				XK_F6,	spawn,		SHCMD("maim $HOME/Pictures/Screenshots/pic-full-$(date '+%y%m%d-%H%M-%S').png") },
	{ ShiftMask,		XK_F6,	spawn,		{.v = (const char*[]){ "maimpick", NULL } } },
	{ MODKEY,			XK_F6,	spawn,		{.v = (const char*[]){ "dmenurecord", NULL } } },
	{ MODKEY|ShiftMask,	XK_F6,	spawn,		{.v = (const char*[]){ "dmenurecord", "kill", NULL } } },
	{ MODKEY,			XK_F7,	spawn,		SHCMD("killall screenkey || screenkey &") },
	...
	{ 0, XF86XK_HomePage,		spawn,		{.v = (const char*[]){ TERMINAL, "-e",  "lfub",  "/", NULL } } },
